...
public:
	...
	volatile PCB* next_blocked; //next in the waitToComplete() list, starts with 0
    ...
    void block_add();
	/*
	helper for waitToComplete()for adding running 
	thread to the called threads blocked list
	*/
